...
#pragma warning restore CA2227 // Collection properties should be read only
        ...
        public static readonly DependencyProperty HeaderVisibilityProperty = DependencyProperty.Register("HeaderVisibility", typeof(Visibility), typeof(SettingsPageControl), new PropertyMetadata(default(Visibility)));
